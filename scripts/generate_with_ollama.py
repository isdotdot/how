...
SYSTEM_PROMPT = """
You write clear, step-by-step posts that answer 'How does ... work?' or 'How do I ... ?' questions. Tone: practical and beginner-friendly.
"""

USER_PROMPT = """
Write ONE complete blog post for a 'How does ... work?' or 'How do I ... ?' question. Include intro, steps/explanation, and summary. First line must be '# Title'. Write 700-900 words in Markdown. No front matter, no JSON, no backticks.
"""
