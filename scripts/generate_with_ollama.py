...
TITLE_DEFAULT = "How Things Work"
TAGS = ["how", "guide"]
DESCRIPTION_FALLBACK = "A simple, practical guide explaining how something works or how to do something."
...
USER_PROMPT = """
Write ONE complete blog post that answers a common 'How does ... work?' or 'How do I ... ?' question.

The post should include:
- A short intro explaining what the reader will learn.
